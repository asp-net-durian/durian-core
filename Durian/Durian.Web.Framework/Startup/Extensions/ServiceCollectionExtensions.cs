...
namespace Nop.Web.Framework.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddDurianObjectContext(this IServiceCollection services)
        {
        ...
        /// <summary>
        /// Add HangFire Profiler Service
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        /// <returns>A builder for configuring MVC services</returns>
        public static void AddHangFireProfiler(this IServiceCollection services)
        {
            var nopConfig = services.BuildServiceProvider().GetRequiredService<NopConfig>();

            var dataSettings = DataSettingsManager.LoadSettings();

            var hangFireConnectionString = dataSettings.DataConnectionString;
            ...
            services.AddHangfire(c =>
                c.UseSqlServerStorage(
                        ...
                        {
                            SchemaName = $"Schedule{DateTime.Now.Year}"
                        }).UseConsole()
